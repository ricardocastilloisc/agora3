...
module.exports = __webpack_require__(/*! /Users/ricardoorlandocastilloolivera/agora3/src/main.ts */"zUnb");
...
AppComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: AppComponent, selectors: [["app-root"]], decls: 2, vars: 0, consts: [[1, "agora-theme"]], template: function AppComponent_Template(rf, ctx) { if (rf & 1) {
...
const routes = [{ path: 'video', loadChildren: () => __webpack_require__.e(/*! import() | video-video-module */ "video-video-module").then(__webpack_require__.bind(null, /*! ./video/video.module */ "Q4H4")).then(m => m.VideoModule) }];
